...
public class VaildateCodeUtil {
    ...
    public VaildateCodeUtil() {
        creatImage();
    }

    public VaildateCodeUtil(int width, int height) {
        this.width = width;
        this.height = height;
        creatImage();
    }

    public VaildateCodeUtil(int width, int height, int codeCount) {
        this.width = width;
        this.height = height;
    ...
    public VaildateCodeUtil(int width, int height, int codeCount, int lineCount) {
        this.width = width;
        this.height = height;
        this.codeCount = codeCount;
